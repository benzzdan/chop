                ...
                <div class="row">
                    <div class="col-xs-5 col-sm-6 col-md-4 logo-col">
                        [{block name="layout_header_logo"}]
                            ...
                            <a href="[{$oViewConf->getHomeLink()}]" title="[{$oxcmp_shop->oxshops__oxtitleprefix->value}]" id="chop-logo">
                                <img src="[{$oViewConf->getImageUrl($slogoImg)}]" alt="[{$oxcmp_shop->oxshops__oxtitleprefix->value}]" style="width: 120px; height: auto;">
                            </a>
                        [{/block}]
                    </div>
